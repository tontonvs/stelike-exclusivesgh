...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Stelike Exclusives — Custom Furniture, Accra" },
      {
        name: "description",
        content:
          "Custom TV consoles, center tables, LED mirrors, bed frames and dressers built in Accra, Ghana.",
      },
      { name: "author", content: "Stelike Exclusives" },
      { property: "og:title", content: "Stelike Exclusives — Custom Furniture, Accra" },
      {
        property: "og:description",
        content: "Custom furniture design and fabrication in Ghana.",
      },
